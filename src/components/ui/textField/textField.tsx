...
export const TextField = (props: TextFieldPros) => {
  ...
  const FieldPassword = () => (
    <div className={s['password-field']}>
      <input className={s.input} type='password' placeholder={placeholder} disabled={disabled} {...rest}/>
  ...
  const FieldSearch = () => (
    <div className={s['search-field']}>
      ...
      <input className={s.input} type='search' placeholder={placeholder} disabled={disabled} {...rest}/>
    </div>
  );
  ...
  return (
    <div className={`${className ?? ''} ${s['text-field']} ${disabled ? s.disabled : ''} ${error ? s.error : ''}`}>
      ...
      {!variant && <input className={s.input} type='text' placeholder={placeholder} disabled={disabled} {...rest}/>}
